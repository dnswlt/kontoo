...
func TestParseDecimalAsMicros(t *testing.T) {
	tests := []struct {
		...
		{"pct_1", "1%", 10_000},
		{"pct_100", "100%", 1_000_000},
		{"pct_frac", "12.34%", 123_400},
		{"pct_maxfrac", "12.3456%", 123_456},
		{"pct_fractrunc", "12.34567%", 123_456},
		{"pct_negfractrunc", "-12.34567%", -123_456},
		{"pct_min", "0.0001%", 1},
		{"pct_max", "9223372036853.9999%", 92233720368539999},
		{"min_pos", "0.000001", 1},
		{"min_neg", "-0.000001", -1},
